<div class="field">
	...
	<form action=\"index.php?action=updateEvenement&event=$nomEvenement\" method=\"post\" id=\"creerEvenementField\">
		<table>
			<tr>
			...
			<tr>
				...
				<td><input type=\"text\" name=\"lieu\" value=\"$lieu\"placeholder=\"Précisez où il est organisé\" required/></td>
			</tr>
			<tr>
				<th>Début :</th>
				<td  class=\"labelDate\"><input type=\"date\" name=\"dateDeDebut\" value=\"$dateOuverture\" placeholder=\"2016-01-01\" required/></td>				
			</tr>
			
			<tr>
			<th>Se termine :</th>
				<td  class=\"labelDate\"><input type=\"date\" name=\"dateDeFin\" value=\"$dateFermeture\" placeholder=\"2016-01-01\" /></td>
			</tr>
			
			<tr>
				<th><p>Image :</p></th>
				<td><input type=\"text\" name=\"lienImage\" value=\"$image\" placeholder=\"Insérez ici le lien de l'image\" required/></td>
			</tr>
			
			<tr>
				<th>Lien :</th>
				<td><input type=\"text\" name=\"lien\" value=\"$lien\" placeholder=\"Coller ici le lien de l'évènement (s'il y en a un)\" /></td>
			</tr>
			
			<tr>
				<th>Description de l'événement :</th>
				<td><textarea rows=\"7\" cols=\"50\" name=\"description\" value=\"$description\" placeholder=\"Décrivez les spécificités de votre événement\"></textarea></td>
			</tr>
			<tr>
				<th>Nom de l'organisateur :</th>
				<td><input type=\"text\" name=\"nomOrganisateur\" value=\"$nomOrganisateur\"/></td>
			</tr>
			<tr>
				<th>Description de l'organisateur :</th>
				<td><textarea rows=\"7\" cols=\"50\" name=\"descriptionOrganisateur\" value=\"$descriptionOrganisateur\" placeholder=\"Présentez-vous ici\"></textarea></td>
			</tr>
			
			<tr>
				<th>Créer des places</th>
				<td><input type=\"number\" name=\"nombrePlaces\" value=\"$place\" placeholder=\"Donnez un nombre de places pour votre événement\" required/></td>
			</tr>";
			?>
			<tr>
			...
			<tr>
				<th />
				<td>
					<a href="index.php?action=gererEvenement" class="normalButton"> Annuler</a>
